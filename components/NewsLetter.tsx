    ...
    <section className="newsletter">
      <div className="container flex">
        ...
        <p className="newsletter__info">
          Want to&nbsp;stay up&nbsp;to&nbsp;date with all promotions and special
          offers?
        </p>
        <p className="newsletter__info">
          Subscribe to&nbsp;our newsletter and receive notifications about the
          most profitable promotions directly to&nbsp;your inbox. Don&rsquo;t
          miss your chance for exclusive offers and nice discounts! Simply click
          the subscribe button and leave your email address below.
          We&nbsp;promise that your address will be&nbsp;used exclusively
          to&nbsp;send you information about marketplace promotions, without
          intrusive advertising or&nbsp;spam. Don&rsquo;t miss the opportunity
          to&nbsp;enjoy the flavor and save money at&nbsp;the same time.
        </p>
        <p className="newsletter__info">Sign up&nbsp;for our newsletter now!</p>
