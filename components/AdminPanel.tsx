...
const AdminPanel: React.FC = () => {
  ...
  }, [file, category, currentPrice, measure, lastPrice, title, weight, image, description]);
  ...
  const handleUpdateItem = (id: number) => {
    setItems(
      items.map((item) =>
        item.id === id ? { ...item, title: `${item.title} (updated)` } : item,
      ),
    );
  };
    ...
    <section className="apanel">
      <div className="apanel-container">
        {items.map((item) => (
          <div key={item.id} className="apanel-row">
            <div className="container flex">
              <p className="apanel__id">{item.id}</p>
              <p className="apanel__name">{item.title}</p>
              <p className="apanel__category">{item.category}</p>
              <button
                className="apanel__additional btn-reset"
                onClick={() => openAdditionalInfoModal(item)}
              >
                Show Additional Info
              </button>
              <button
                className="apanel__update btn-reset"
                disabled
              ...
              <button
                className="apanel__delete btn-reset"
        ...
        <div className="add-items container flex">
          <button
            className="add-items__button btn-reset"
      ...
      <Modal
        show={isAdditionalInfoModalOpen}
        onHide={() => setIsAdditionalInfoModalOpen(false)}
      >
      ...
      <Modal
        ...
        onHide={() => setIsDeleteConfirmModalOpen(false)}
      >
        <Modal.Header closeButton>
