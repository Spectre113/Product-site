...
const Header: React.FC = () => {
  ...
  const onRegister = useCallback(
      async (
          registerBlock: HTMLElement,
          logContent: HTMLElement,
          registerSuccessMessage: HTMLElement
      ) => {
  ...
  useEffect(() => {
    ...
    validator3
      ...
      .onSuccess((event: Event) => {
        event.stopPropagation();
        event.preventDefault();
        onRegister(registerBlock as HTMLElement, logContent as HTMLElement, registerSuccessMessage as HTMLElement);
      });
  ...
  }, [cart, router, name, password, onRegister]);
      ...
      <div className="container flex">
        ...
        <div className="header__controls flex">
          <button className="header__log btn-reset flex">
            ...
            >
              <path
                d="M9.5 1.5L2 5.25L9.5 9L17 5.25L9.5 1.5Z"
                stroke="#121723"
                strokeWidth="1.5"
                strokeLinecap="round"
          ...
          <div className="header__log-content none flex">
            <div>
              ...
              <h2 className="header__log-title">Log-in</h2>
              <p className="header__log-info">
                If you do not have an account yet,{" "}
                <button className="btn-reset header__log-register">
                  register here
                </button>
                .
              </p>
              <form
                ...
                method="POST"
                className="header__log-form flex"
                id="log-form"
              >
                <label htmlFor="name" className="header__log-label">
                  <input
                    type="text"
                    className="header__log-input"
                    placeholder="Login"
                    name="name"
                    id="name"
                  ></input>
                ...
                <button className="header__log-button btn-reset">Enter</button>
              </form>
            </div>
          </div>
          <div className="header__register-block none flex">
            <div>
              ...
              <h2 className="header__log-title">Register</h2>
              <form
                action={"/api/register"}
                method="POST"
                className="header__log-form flex"
              ...
              <div>
                {cart.map((item, index) => (
                  <div key={index} className="basket-item flex">
                    <span>
                      {item.title} - {item.currentPrice} {item.measure}
                    </span>
                    <button
